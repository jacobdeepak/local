/*! HTML_CodeSniffer - v2.1.1 - 2017-12-07 */
/**
 * +--------------------------------------------------------------------+
 ...
 */
  _global.HTMLCS_Section508_Sniffs_A = {
    ...
    addMediaAlternativesResults: function(top) {
      var errors = HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_1_1_1_1.testMediaTextAlternatives(
        top
      );
 ...
 */
  _global.HTMLCS_Section508_Sniffs_L = {
    ...
    addProcessLinksMessages: function(top) {
      ...
      for (var i = 0; i < errors.noTelusId.length; i++) {
        console.log(errors.noTelusId[i]);
        HTMLCS.addMessage(
          HTMLCS.WARNING,
          errors.noTelusId[i],
          "Anchor element found no telusId attribute.",
          "NoContentAnchor"
        );
      }
    },
    processLinks: function(top) {
      ...
      for (var el = 0; el < elements.length; el++) {
        ...
        if (element.hasAttribute("telusId") === false) {
          console.log("Telus Id missing");
          errors.noTelusId.push(element);
        }
        if (
 ...
 */
  _global.HTMLCS_WCAG2AAA = {
    ...
    getMsgInfo: function(code) {
      ...
      var successCrit = msgCodeParts[3]
        .split("_")
        .slice(0, 3)
        .join(".");
    ...
    testLinkStutter: function(element) {
      if (element.parentNode.nodeName.toLowerCase() === "a") {
        ...
        if (nodes.anchor.text === "") {
          var prevLink = HTMLCS.util.getPreviousSiblingElement(
            anchor,
            "a",
            true
          );
          ...
          if (
            ...
            if (nodes.previous.text !== "" && nodes.anchor.alt === "") {
              ...
              nodes.previous.text.toLowerCase() ===
              nodes.anchor.alt.toLowerCase()
            ) {
              HTMLCS.addMessage(
                HTMLCS.ERROR,
                element,
      ...
      if (element.hasAttribute("aria-labelledby") === true) {
        if (HTMLCS.util.hasValidAriaLabel(element) === false) {
          HTMLCS.addMessage(
            HTMLCS.WARNING,
            element,
            'This form control contains an aria-labelledby attribute, however it includes an ID "' +
              element.getAttribute("aria-labelledby") +
              '" that does not exist on an element. The aria-labelledby attribute will be ignored for labelling test purposes.',
            "ARIA16,ARIA9"
          );
        } else {
    ...
    testTableHeaders: function(table) {
      ...
      if (
        ...
        if (scopeAttr.used === false && headersAttr.used === false) {
          ...
          (headersAttr.missingThId.length > 0 ||
            headersAttr.missingTd.length > 0)
        ) {
        ...
        if (
          ...
          if (processNode === true) {
            ...
            if (style) {
              ...
              var contrastRatio = HTMLCS.util.contrastRatio(
                bgColour,
                style.color
              );
 ...
 */
  _global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_3 = {
    ...
    process: function(element, top) {
      if (element === top) {
        var failures = HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_3_Contrast.testContrastRatio(
          top,
          4.5,
          3
        );
        for (var i = 0; i < failures.length; i++) {
          ...
          if (recommendText.length > 0) {
            recommendText =
              " Recommendation: change " + recommendText.join(", ") + ".";
          }
          if (isAbsolute === true) {
            code += ".Abs";
            HTMLCS.addMessage(
              HTMLCS.WARNING,
              element,
              "This element is absolutely positioned and the background color can not be determined. Ensure the contrast ratio between the text and all covered parts of the background are at least " +
                required +
                ":1.",
              code
            );
            ...
            HTMLCS.addMessage(
              HTMLCS.WARNING,
              element,
              "This element's text is placed on a background image. Ensure the contrast ratio between the text and all covered parts of the image are at least " +
                required +
                ":1.",
              code
            );
            ...
            HTMLCS.addMessage(
              HTMLCS.ERROR,
              element,
              "This element has insufficient contrast at this conformance level. Expected a contrast ratio of at least " +
                required +
                ":1, but text in this element has a contrast ratio of " +
                value +
                ":1." +
                recommendText,
              code
  ...
  _global.HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_1_3_1_2 = {
    ...
    process: function(element, top) {
      ...
      for (var i = 0; i <= langEls.length; i++) {
        ...
        if (
          !langEl.documentElement &&
          langEl.nodeName.toLowerCase() !== "html"
        ) {
  ...
  _global.HTMLCS_WCAG2AAA_Sniffs_Principle3_Guideline3_2_3_2_5 = {
    ...
    checkNewWindowTarget: function(link) {
      ...
      if (hasTarget === true) {
        ...
        if (
          target === "_blank" &&
          /new window/i.test(link.innerHTML) === false
        ) {
          HTMLCS.addMessage(
            HTMLCS.WARNING,
            link,
      ...
      for (var el = 0, ll = elements.length; el < ll; el++) {
        ...
        if (matchingRequiredNames) {
          for (var i = 0; i < matchingRequiredNames.length; i++) {
            ...
            if (requiredName === "_content") {
              ...
              var hasLabel = HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_3_1_3_1.testLabelsOnInputs(
                element,
                top,
                true
              );
          ...
          if (i === matchingRequiredNames.length) {
            ...
            var msg =
              "This " +
              msgNodeType +
              " does not have a name available to an accessibility API. Valid names are: " +
              builtAttrs.join(", ") +
              ".";
            errors.push({
              element: element,
        ...
        if (valueFound === false) {
          ...
          var msg =
            "This " +
            msgNodeType +
            " does not have a value available to an accessibility API.";
          var builtAttr = "";
          var warning = false;
 ...
 */
  _global.HTMLCS = new function() {
    ...
    */
     ...
     * @param {Object}   options  The options for the standard (e.g. exclude sniffs).
     */
    var _registerStandard = function(
      standard,
      callback,
      failCallback,
      options
    ...
    var _getSniffPath = function(standard, sniff) {
      ...
      parts.pop();
      var path =
        parts.join("/") + "/Sniffs/" + sniff.replace(/\./g, "/") + ".js";
      return path;
    };
    /**
  ...
  _global.HTMLCS.util = (function() {
    ...
    self.colourStrToRGB = function(colour) {
      ...
      if (colour.substring(0, 3) === "rgb") {
        ...
        var matches = /^rgba?\s*\((\d+),\s*(\d+),\s*(\d+)([^)]*)\)$/.exec(
          colour
        );
        colour = {
          red: matches[1] / 255,
  ...
  _global.HTMLCSAuditor = new function() {
    ...
    var buildSummaryButton = function(id, className, title, onclick) {
      ...
      buttonInner.className =
        _prefix + "button-icon " + _prefix + "button-" + className;
    ...
    var buildRadioButton = function(groupName, value, title, checked) {
      ...
      var content =
        '<span class="' + _prefix + 'radio-title">' + title + "</span>";
    ...
    var buildHeaderSection = function(standard, wrapper) {
      ...
      header.innerHTML = "TDa11y from Telus";
    ...
    var buildDetailSummarySection = function(issue, totalIssues) {
      ...
      var prevButton = buildSummaryButton(
        _prefix + "button-previous-issue",
        "previous",
        "Previous Issue",
        function(target) {
          ...
          if (newIssue >= 1) {
            ...
            var issueList = _doc.querySelectorAll(
              ".HTMLCS-issue-detail-list"
            )[0];
            issueList.firstChild.style.marginLeft =
              parseInt(issueList.firstChild.style.marginLeft, 10) + 300 + "px";
            pointToIssueElement(newIssue - 1);
          }
        }
      );
      var nextButton = buildSummaryButton(
        _prefix + "button-next-issue",
        "next",
        "Next Issue",
        function(target) {
          var newIssue = Number(issue) + 1;
    ...
    var buildSettingsSection = function() {
      ...
      useStandardLabel.setAttribute(
        "for",
        _prefix + "settings-use-standard-select"
      );
      ...
      for (var level in levels) {
        ...
        levelDiv.className =
          _prefix + "issue-tile " + _prefix + level.toLowerCase();
        ...
        var levelSwitch = buildCheckbox(
          _prefix + "include-" + level,
          "Toggle display of " + level + " messages",
          checked,
          disabled,
          function(input) {
            ...
            var enable = false;
            if (
              _doc.getElementById(_prefix + "include-error").disabled === false
            ) {
              _options.show.error = _doc.getElementById(
                _prefix + "include-error"
              ).checked;
              enable = enable || _options.show.error;
            }
            if (
              _doc.getElementById(_prefix + "include-warning").disabled ===
              false
            ) {
              _options.show.warning = _doc.getElementById(
                _prefix + "include-warning"
              ).checked;
              enable = enable || _options.show.warning;
            }
            if (
              _doc.getElementById(_prefix + "include-notice").disabled === false
            ) {
              _options.show.notice = _doc.getElementById(
                _prefix + "include-notice"
              ).checked;
              enable = enable || _options.show.notice;
            }
            if (enable === true) {
              viewReportDiv.className = viewReportDiv.className.replace(
                / disabled/g,
                ""
              );
            } else {
      ...
      if (_options.show !== undefined) {
        var enable =
          _options.show.error || _options.show.warning || _options.show.notice;
        if (enable === false) {
          viewReportDiv.className += " disabled";
        }
      } else {
    ...
    var buildMessageSummary = function(id, message) {
      ...
      msg.onclick = function() {
        ...
        setTimeout(function() {
          detailList.className = detailList.className.replace(
            new RegExp(" " + _prefix + "transition-disabled"),
            ""
          );
        }, 500);
        var list = _doc.querySelectorAll(".HTMLCS-inner-wrapper")[0];
        ...
        var newSummary = buildDetailSummarySection(
          parseInt(id) + 1,
          _messages.length
        );
    ...
    var buildMessageDetail = function(id, message, standard) {
      ...
      var standardObj = HTMLCS.util.getElementWindow(_doc)[
        "HTMLCS_" + standard
      ];
      ...
      for (var i = 0; i < msgInfo.length; i++) {
        refContent +=
          "<em>" + msgInfo[i][0] + ":</em> " + msgInfo[i][1] + "<br/>";
      }
      ...
      if (pointer.isPointable(message.element) === false) {
        ...
        if (message.element.ownerDocument === null) {
          ...
          var body = message.element.ownerDocument.getElementsByTagName(
            "body"
          )[0];
      ...
      if (_options.customIssueSource) {
        ...
        var btnPointTo = buildSummaryButton(
          _prefix + "button-point-to-element-" + id,
          "pointer",
          "Point to Element",
          function() {
        ...
        if (message.element.outerHTML) {
          ...
          if (message.element.innerHTML.length > 31) {
            var outerHTML = message.element.outerHTML.replace(
              message.element.innerHTML,
              message.element.innerHTML.substr(0, 31) + "..."
            );
          } else {
          ...
          var msgElementSourceInner = _doc.createElement("div");
          msgElementSourceInner.className =
            _prefix + "issue-source-not-supported";
          var nsText =
    ...
    var buildNavigation = function(page, totalPages) {
      ...
      prev.onclick = function() {
        ...
        if (totalPages > 1) {
          next.className = next.className.replace(
            new RegExp(" " + _prefix + "disabled"),
            ""
          );
        }
        pageNum.innerHTML = "";
        pageNum.appendChild(
          document.createTextNode("Page " + _page + " of " + totalPages)
        );
      ...
      next.onclick = function() {
        ...
        if (totalPages > 1) {
          prev.className = prev.className.replace(
            new RegExp(" " + _prefix + "disabled"),
            ""
          );
        }
    ...
    var pointToIssueElement = function(issue) {
      ...
      var btnPointTo = _doc.getElementById(
        _prefix + "button-point-to-element-" + issue
      );
      pointer.container =
        self.pointerContainer || _doc.getElementById("HTMLCS-wrapper");
    ...
    this.includeCss = function(prefix, doc) {
      ...
      for (var i = 0; i < exLinks.length; i++) {
        if (
          new RegExp(prefix + ".css").test(exLinks[i].getAttribute("href")) ===
          true
        ) {
          foundCss = true;
          break;
    ...
    this.getParentElement = function() {
      ...
      if (_options.parentElement) {
        ...
        for (var i = 0; i < _top.frames.length; i++) {
          try {
            if (
              window.frames[i].frameElement.nodeName.toLowerCase() === "frame"
            ) {
        ...
        for (var i = 0; i < _messages.length; i++) {
          ...
          if (wrapper) {
            if (wrapper === _messages[i].element) {
              ...
              wrapper.contains &&
              wrapper.contains(_messages[i].element) === true
            ) {
              ignore = true;
            } else if (
              wrapper.compareDocumentPosition &&
              (wrapper.compareDocumentPosition(_messages[i].element) & 16) > 0
            ) {
              ignore = true;
            }
          }
          ...
          for (var j = 0; j < options.ignoreMsgCodes.length; j++) {
            if (
              new RegExp(options.ignoreMsgCodes[j]).test(_messages[i].code) ===
              true
            ) {
              ignore = true;
              break;
      ...
      if (response && response.currentVersion !== null) {
        if (response.newVersion > response.currentVersion) {
          ...
          _doc.documentElement
            .querySelector(".HTMLCS-settings")
            .appendChild(msgElementSource);
          var msg =
    ...
    var pointer = {
      ...
      getPointerDirection: function(elem) {
        ...
        var doc = elem.ownerDocument;
        myPointer.className = myPointer.className.replace(
        ...
        var scrollY = Math.max(
          ...
          Math.min(
            rect.y1 - 100,
            doc.documentElement.offsetHeight - winDim.height
          )
        );
        ...
        if (direction === null) {
          ...
          if (isFixed === true) {
            ...
            while (targetY >= 0) {
              ...
              var scrollCoords = this.getScrollCoords(
      ...
      showPointer: function(elem, direction) {
        ...
        if (
          ...
          setTimeout(function() {
            self.container.className = self.container.className.replace(
              "HTMLCS-translucent",
              ""
            );
          }, 4e3);
      ...
      bounce: function(myPointer, callback, direction) {
        ...
        initialPos =
          Number(myPointer.style[style].replace("px", "")) + initalPosOffset;
